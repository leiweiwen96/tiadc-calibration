...
POST_NL_MAX_DROP_DB = _env_float("POST_NL_MAX_DROP_DB", 0.3)  # 任何指标允许的最大退化（dB/dBc）
...
POST_NL_STEPS = _env_int("POST_NL_STEPS", 1200)
POST_NL_LR = _env_float("POST_NL_LR", 1e-3)
...
if __name__ == "__main__":
    ...
    if POST_NL_ENABLE:
        ...
        alpha_list = [0.0, 0.15, 0.25, 0.35, 0.5, 0.7, 1.0]
